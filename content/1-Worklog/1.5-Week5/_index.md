...
| Thu | - Run DiskSpd & fio benchmarks on FSx <br> - Create CloudWatch Alarm (Total Throughput >200 MB/s, SNS email) <br> - Enable Data Deduplication (MinimumFileAgeDays=0) <br> - Enable Shadow Copies (manual snapshot, file restore) <br> - Scale throughput to 64 MB/s and storage +10% | 21/05/2026 | 21/05/2026 | <https://docs.aws.amazon.com/fsx/latest/WindowsGuide/performance.html> |
