...
| --- | ---- | ---------- | --------------- | ------------------ |
| Mon | - Export VMware VM to OVF (.vmdk), upload to S3 <br> - Import to AMI via vmimport, launch EC2 'Import-Server', verify SSH <br> - Export EC2 back to VMDK via create-instance-export-task <br> - Create S3 Bucket for Storage Gateway (Singapore) | 18/05/2026 | 18/05/2026 | <https://docs.aws.amazon.com/vm-import/latest/userguide/vmimport-image-import.html> |
| Tue | - Deploy FSx lab via CloudFormation (2 AZ, ~40 min) <br> - Create FSx SSD Multi-AZ (300 GiB) and HDD Multi-AZ (2000 GiB) <br> - RDP to Windows Instance 0, map drive Z: to FSx UNC, sync NASA data <br> - Create File Shares (application, data) via fsmgmt.msc | 19/05/2026 | 19/05/2026 | <https://docs.aws.amazon.com/fsx/latest/WindowsGuide/what-is.html> |
