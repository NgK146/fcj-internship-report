...
Giải pháp sử dụng IAM policy với điều kiện (condition) để giới hạn quyền chỉ trên `alias/customer-<tenant-id>`, kết hợp CloudTrail để audit. Điều này giúp giảm rủi ro và dễ tuân thủ các tiêu chuẩn bảo mật.
