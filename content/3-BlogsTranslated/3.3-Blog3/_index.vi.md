...
1. Tải CloudFormation template từ bài blog gốc.
2. Cấu hình account IDs và email recipients.
3. Verify email trong Amazon SES.
4. Deploy stack.
5. Cấp Billing permission cho IAM Role.
6. Cấu hình EventBridge rule với cron expression.
...
**Link bài gốc:** <https://aws.amazon.com/blogs/architecture/email-delta-cost-usage-report-in-a-multi-account-organization-using-aws-lambda/>
